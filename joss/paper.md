...
|---------------|----------------------------------------------------------------------------------------------------------------------------------|
| 1             | HD data provided as (e.g., $100\times 100\:\textrm{m}^2$) raster or polygon grid with the same or in a different coordinate reference system  |
|               |                                                                                                                                  |
